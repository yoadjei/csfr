...
\begin{table*}[htbp]
\centering
\caption{Bounded-Unknown and abstention rates by cell. The binary Bounded-Unknown flag at threshold 0.5 on isolated-missing-fraction saturates: CF1/CF3/CF4~L1 report zero, CF2/CF3/CF4 from L2 upward report 1.0, making it a family-level indicator rather than a per-patch signal. The continuous isolated-missing-fraction (columns: mean, SD, Q25, median, Q75) is reported for reference and should be preferred for analysis. The signal-covering subset count $n_{\text{sig}}$ (patches with any C3 violation in observed region) is empty for CF1 entirely and for CF3/CF4 at L1--L3, and saturates to 1000 for CF2 from L2 and CF3/CF4 from L4 upward.}
...
\toprule
\textbf{Fam.} & \textbf{Lvl} & \textbf{BU Rate} & \textbf{Imf Mean} & \textbf{Imf SD} & \textbf{Imf Median} & \textbf{n\_sig} \\
\midrule
